...
impl CortexMKernelConfigInterface for KernelConfig {
    ...
    /// For QEMU compatibility, using 12 MHz (LM3S6965EVB clock).
    /// Real hardware would use 200 MHz.
    const SYS_TICK_HZ: u32 = 12_000_000;

    /// Number of MPU regions available.
    /// ARM Cortex-M4 (PMSAv7) has 8 regions.
...
impl NvicConfigInterface for NvicConfig {
    ...
    /// Conservative estimate, adjust based on AST1030 datasheet.
